...
document.formAdd.action="<%=path %>/chushouAll.action?first=0&max=10";
	
	
}else if(document.formAdd.query[1].checked==true){
   document.formAdd.action="<%=path %>/chuzuAll.action?first=0&max=10";
	
}else if(document.formAdd.query[2].checked==true){
	document.formAdd.action="<%=path %>/qiugouAll.action?first=0&max=10";
}else{
	document.formAdd.action="<%=path %>/qiuzuAll.action?first=0&max=10";
}
