...
<td><a href="<%=path %>/qiuzuDetailQian.action?id=${qiuzu.id}" target="_self"><font color="#333333">${qiuzu.dizhi} </font> </a></td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<td><a href="<%=path %>/qiuzuDetailQian.action?id=${qiuzu.id}" target="_self"><font color="#333333">${qiuzu.zhuangxiu}</font> </a></td>&nbsp;
																			

<td><a href="<%=path %>/qiuzuDetailQian.action?id=${qiuzu.id}" target="_self"><font color="#333333">${qiuzu.huxing}</font> </a></td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<td><a href="<%=path %>/qiuzuDetailQian.action?id=${qiuzu.id}"  target="_self"><font color="#333333">${qiuzu.jiage}元/月</font> </a></td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<td><a href="<%=path %>/qiuzuDetailQian.action?id=${qiuzu.id}" target="_self"><font color="#333333"><fmt:formatDate value="${qiuzu.fabushi}" pattern="yyyy-MM-dd"/></font> </a></td>
...
<div class="clear"></div>
	      ...
	      <a href="<%=path %>/qiuzuAll.action?first=${requestScope.prefirst}&max=10">上一页</a>
	      <a href="<%=path %>/qiuzuAll.action?first=${requestScope.nextfirst}&max=10">下一页</a>
	      </div>
