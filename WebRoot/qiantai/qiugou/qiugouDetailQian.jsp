	      ...
	      <div class="content">
	          ...
	          <div>
		           <table width="100%" border="0" cellpadding="5" cellspacing="5">
							    <tr>
							       <td align="left">户型要求：${requestScope.qiugou.huxing }</td>
							    </tr>
							    <tr>
							       <td align="left">面积要求：${requestScope.qiugou.mianji }</td>
							    </tr>
							    <tr>
							       <td align="left">装修情况：${requestScope.qiugou.zhuangxiu }</td>
							    </tr>
							    <tr>
							       <td align="left">价格要求：${requestScope.qiugou.jiage }</td>
							    </tr>
							    <tr>
							       <td align="left">地址要求：${requestScope.qiugou.dizhi }</td>
							    </tr>
							    <tr>
							       <td align="left">联系&nbsp;&nbsp;&nbsp;人：${requestScope.qiugou.lianxiren }</td>
							    </tr>
							    <tr>
							       <td align="left">联系电话：${requestScope.qiugou.lianxihua }</td>
							    </tr>
							    <tr>
							       <td align="left">发布时间：<fmt:formatDate value="${requestScope.qiugou.fabushi }" pattern="yyyy-MM-dd"/></td>
							    </tr>
			                </table>
	          </div>
	      </div>
