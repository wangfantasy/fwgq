	      ...
	      <div class="content">
	          ...
	          <div>
		           <table width="100%" border="0" cellpadding="5" cellspacing="5">
							    <tr>
							       <td align="left"><img width="400" height="240" src="<%=path %>/${requestScope.chuzu.fujian}" style="border:1px solid #ccc; padding:3px;"/></td>
							    </tr>
							    <tr>
							       <td align="left">房屋户型：${requestScope.chuzu.huxing }</td>
							    </tr>
							    <tr>
							       <td align="left">房屋面积：${requestScope.chuzu.mianji }</td>
							    </tr>
							    <tr>
							       <td align="left">装修情况：${requestScope.chuzu.zhuangxiu }</td>
							    </tr>
							    <tr>
							       <td align="left">出租价格(元/月)：${requestScope.chuzu.jiage }</td>
							    </tr>
							    <tr>
							    ...
							    <tr>
							       <td align="left">发布时间：<fmt:formatDate value="${requestScope.chuzu.fabushi }" pattern="yyyy-MM-dd"/></td>
							    </tr>
			                </table>
	          </div>
	      </div>
