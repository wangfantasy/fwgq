...
<td><a href="<%=path %>/chushouDetailQian.action?id=${chushou.id}" target="_self"><font color="#333333">${chushou.dizhi} </font> </a></td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><a href="<%=path %>/chushouDetailQian.action?id=${chushou.id}" target="_self"><font color="#333333">${chushou.huxing}</font> </a></td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<td><a href="<%=path %>/chushouDetailQian.action?id=${chushou.id}"  target="_self"><font color="#333333">${chushou.jiage}</font> </a></td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<td><a href="<%=path %>/chushouDetailQian.action?id=${chushou.id}" target="_self"><font color="#333333"><fmt:formatDate value="${chushou.fabushi}" pattern="yyyy-MM-dd"/> </font> </a></td>
...
<div class="clear"></div>
	      ...
	      <a href="<%=path %>/chushouAll.action?first=${requestScope.prefirst}&max=10">上一页</a>
	      <a href="<%=path %>/chushouAll.action?first=${requestScope.nextfirst}&max=10">下一页</a>
	      </div>
