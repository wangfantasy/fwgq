	      ...
	      <div class="content">
	          ...
	          <div>
		           <table width="100%" border="0" cellpadding="9" cellspacing="9">
							    <tr>
							       <td align="left">信息标题：${requestScope.gonggao.gonggaoTitle }</td>
							    </tr>
							    <tr>
							       <td align="left">信息内容：${requestScope.gonggao.gonggaoContent }</td>
							    </tr>
							    <tr>
							       <td align="left">发布时间：${requestScope.gonggao.gonggaoData }</td>
							    </tr>
			                </table>
	          </div>
	      </div>
