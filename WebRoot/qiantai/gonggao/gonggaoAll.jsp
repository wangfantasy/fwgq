...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
        ...
        function gonggaoDetailQian(gonggaoId)
        {
             var url = "<%=path %>/gonggaoDetailQian.action?gonggaoId="+gonggaoId;
	          ...
	          <div>
		           <c:forEach items="${requestScope.gonggaoList}" var="gonggao" varStatus="sta">
                       <div class="c1-bline" style="padding:7px 0px;">
                        <div class="f-left">
                             <img src="images/netubiao.gif" align="middle" class="img-vm" border="0"/> 
                             <a href="#" onclick="gonggaoDetailQian(${gonggao.gonggaoId })">${gonggao.gonggaoTitle }</a>
                        </div>
