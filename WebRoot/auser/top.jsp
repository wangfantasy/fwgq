    ...
    <head>
        ...
        <script type="text/javascript">
            function logout()
            {
               ...
               {
                   window.parent.location="<%=path %>/exit.action";
               }
            }
    ...
    <body text=#000000 bgColor=#ffffff leftMargin=0 rightmargin="0" topMargin=0 marginheight="0" marginwidth="0">
        <div class="Header HeaderTop">
            <div class="list_bar">
                 ...
                 <span style="float:right;color: white;font-weight: bolder;display: block;text-align: left;margin-top: 28px;margin-right: 10px;">
