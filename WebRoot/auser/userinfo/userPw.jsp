...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript">
            function check()
            {
                 ...
                 loginService.userPwEdit(document.formPw.userPw.value,document.formPw.userPw1.value,callback);
            }
	...
	<body leftmargin="2" topmargin="9" background='<%=path%>/images/allbg.gif'>
		<form method="post" action="<%=path%>/userPwEdit.action"
			name="formPw">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="90%" bgcolor="#FFFFFF">
						<input type="text" value="${sessionScope.user.userName }"
							name="userName" style="width: 250px;" disabled="disabled" />
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td width="10%" bgcolor="#FFFFFF" align="right">
