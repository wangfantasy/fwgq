...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function liuyanAdd()
           {
              var url="<%=path %>/auser/liuyan/liuyanAdd.jsp";
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <a href="#" onclick="liuyanDetail(<s:property value="#liuyan.liuyanId"/>)" class="pn-loperator">查看留言内容</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a class="pn-loperator" href="<%=path %>/liuyanDel.action?liuyanId=<s:property value="#liuyan.liuyanId"/>">删除</a>
					</td>
				</tr>
				</s:iterator>
			</table>
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 8px;">
			  <tr>
			    <td>
			      <input type="button" value="添加留言信息" style="width: 120px;" onclick="liuyanAdd()" />
			    </td>
			  </tr>
		    </table>
