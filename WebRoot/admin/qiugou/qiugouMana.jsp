...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function qiugouShenhe(id)
           {
               var strUrl = "<%=path %>/admin/qiugou/qiugouShenhe.jsp?id="+id;
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						 ${qiugou.zt}
						 <input type="button" value="审核" onclick="qiugouShenhe(${qiugou.id})"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
	      ...
	      <a href="<%=path %>/qiugouMana.action?first=${requestScope.prefirst}&max=10">上一页</a>
	      <a href="<%=path %>/qiugouMana.action?first=${requestScope.nextfirst}&max=10">下一页</a>
	      </div>
